...
def _load_prompt() -> str:
    ...
    return (base_dir / "agent_1_main_idea.md").read_text(encoding="utf-8")
...
def build_agent_1_main_idea(model: str | None = None, provider: str | None = None) -> Any:
    ...
    try:
        return Agent(
            name="Deep Book · Agent 1 · Main Idea",
        ...
        return Agent(
            name="Deep Book · Agent 1 · Main Idea (plain)",
            instructions=_load_prompt(),
            model=eff_model,
        )

...
def _load_prompt() -> str:
    ...
    return (base_dir / "agent_2_table_of_contents.md").read_text(encoding="utf-8")
...
def build_agent_2_toc(model: str | None = None, provider: str | None = None) -> Any:
    ...
    try:
        return Agent(
            name="Deep Book · Agent 2 · Table of Contents",
        ...
        return Agent(
            name="Deep Book · Agent 2 · Table of Contents (plain)",
            instructions=_load_prompt(),
            model=eff_model,
        )

...
def _load_prompt() -> str:
    ...
    return (base_dir / "agent_4_adding_subsections.md").read_text(encoding="utf-8")
...
def build_agent_4_add_subsections(model: str | None = None, provider: str | None = None) -> Any:
    ...
    try:
        return Agent(
            name="Deep Book · Agent 4 · Add Subsections",
        ...
        return Agent(
            name="Deep Book · Agent 4 · Add Subsections (plain)",
            instructions=_load_prompt(),
            model=eff_model,
        )

...
def _load_prompt() -> str:
    ...
    return (base_dir / "agent_3_table_of_contents_refinement.md").read_text(encoding="utf-8")
...
def build_agent_3_toc_refine(model: str | None = None, provider: str | None = None) -> Any:
    ...
    try:
        return Agent(
            name="Deep Book · Agent 3 · ToC Refinement",
        ...
        return Agent(
            name="Deep Book · Agent 3 · ToC Refinement (plain)",
            instructions=_load_prompt(),
            model=eff_model,
        )

...
async def result_view_ui_id(res_id: int):
    ...
    html = (
        ...
        f"<script>(function(){const t=localStorage.getItem('ui_theme');if(t==='light'){document.documentElement.setAttribute('data-theme','light');}else{document.documentElement.removeAttribute('data-theme');}})();const RES_ID={res_id};let text=(document.getElementById('raw')?document.getElementById('raw').value:'');let showRaw=false;"

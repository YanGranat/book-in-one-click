...
- topic: тема
- lang: ru|en|auto
- outline_json (опционально): если передан — проанализируй текущую структуру и улучши её: при необходимости удали/добавь/слияй/раздели/переупорядочь/переформулируй разделы и подразделы, убери повторы и пересечения, выровняй сложность по прогрессии от простого к сложному. Верни улучшенную итоговую структуру.
</input>
...
- Если outline_json передан — улучши структуру, сохраняя общую идею темы и усиливая логическую прогрессию.
</requirements>

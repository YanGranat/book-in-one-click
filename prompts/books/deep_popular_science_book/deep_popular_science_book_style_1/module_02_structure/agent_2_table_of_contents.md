...
- Объём: 3-4 раздела.
- Название разделов должны быть простыми и понятными, но достаточно развёрнутыми, чтобы было понятно о чём в них пойдёт речь (но не больше 7-10 слов, иногда допустимо 1-2 слова, если их достаточно, чтобы была понятна суть раздела)
</requirements>
